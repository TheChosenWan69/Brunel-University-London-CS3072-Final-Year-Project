...
public class CustomTilesPath : MonoBehaviour
{
    public CustomPathfindingAlgorithms _customPathfindingAlgorithms;
    public CustomTilesMapGenerator _customTilesMapGenerator;
    ...
    {
        Queue<TilesType> path = _customPathfindingAlgorithms.FindUnitPath(_tileStartPoint, _tileEndPoint);
        if (path == null)
        {
    ...
    {
        foreach (TilesType t in _customTilesMapGenerator.grid)
        {
            t._Text = "";
